...
public class QuotaResourceOne {
	 ...
	 */
	public QuotaResourceOne(Long id, int blockingThreshold) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		QuotaResourceOne other = (QuotaResourceOne) obj;
