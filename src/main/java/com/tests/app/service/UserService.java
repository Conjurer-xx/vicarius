 ...
 */
@Service
public class UserService {package com.tests.app.service;
...
public class UserService {
    ...
    /**
     * Delete a user from both MySQL and Elasticsearch and delete the quota record for the user from both MySQL and Elasticsearch as well
     *
    ...
    public void deleteUser(String userId) {
        ...
        // Mock delete from Elasticsearch
        User elasticUser = elasticUserRepository.findByUserId(userId);
        if (elasticUser != null) {
            elasticUserRepository.delete(elasticUser);
        }
